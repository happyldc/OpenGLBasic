...
//            1.0f, 0.0f   // 右下
    ...
    public void initShaders() {
        vertexShader = loadShader(GLES20.GL_VERTEX_SHADER, com.example.demo.base.egl.Shaders.Companion.getMatrix_texture_vertex_shader());
        fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, Shaders.INSTANCE.getGray_fragment_shader());
