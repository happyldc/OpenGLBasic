 ...
 * @date 2024-09-12
 */
public class FBOTextureEGLHelper extends EGLHelper {
    ...
    private void drawTextureToFBO(int fboBufferId) {
        //绑定FBO
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, fboBufferId);
        //设置清除的颜色
        GLES20.glClearColor(1f, 1f, 1f, 1f);
        GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);
        //使用三角形shader程序
        GLES20.glUseProgram(program);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, fboBufferId);
