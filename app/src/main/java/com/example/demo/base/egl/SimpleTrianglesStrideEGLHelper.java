 ...
 * @date 2024-09-07
 */
public class SimpleTrianglesStrideEGLHelper extends EGLHelper {
    ...
    private final float[] vertexData = {
            ...
            -0.5f, 0.5f, 0.0f,   // 公共边顶点1 左上角
            0.5f, -0.5f, 0.0f,   // 公共边顶点2 右上角
    ...
    public SimpleTrianglesStrideEGLHelper() {
        // 将顶点数据存储到缓冲区中
    ...
    private void onDrawFrame(GLSurface output) {
        ...
        //mode 绘制图形的类型
        //first 从第几个点开始绘制
        //绘制点的个数 4个 四边形 一个公共边2个个点 边两侧各一个点
